...
@section('header') <!--template from theme post1-->
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    <div class="small-1">
                      ...
                      <time class="ml-4 opacity-70 small-3" datetime="2019-07-14 20:00">24 min ago</time>
                    </div>
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    <div class="small-1">
                      ...
                      <time class="ml-4 opacity-70 small-3" datetime="2019-07-14 20:00">6 hours ago</time>
                    </div>
                    <p class="small-2 mb-0">Was my suppliers, has concept how few everything task music.</p>

                    <div class="media mt-4 pb-0">
                      <img class="avatar avatar-sm mr-4" src="../assets/img/avatar/1.jpg" alt="...">

                      <div class="media-body">
                        <div class="small-1">
                          <strong>Maryam Amiri</strong>
                          <time class="ml-4 opacity-70 small-3" datetime="2019-07-14 20:00">39 min ago</time>
                        </div>
                        <p class="small-2 mb-0">Thoughts his tend and both it fully to would the their reached drew project the be I hardly just tried constructing I his wonder, that his software and need out where didn't the counter productive.</p>
                      </div>
                    </div>
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    <div class="small-1">
                      ...
                      <time class="ml-4 opacity-70 small-3" datetime="2019-07-14 20:00">Yesterday</time>
                    </div>
